...
<body>
  <section>
     <div class="container">
        ...
        <div class="user_title">
            <a style="margin-right: 20px; " href="login">Кіру</a>
        </div>
        <h2>Жаңа пайдаланушыны тіркеу</h2>
        ...
        <table>
            ...
            <tr>
                <td class="table_title">Электрондық пошта</td>
                <td><form:input type="text" id="email" path="email" size="40" autofocus="true"></form:input></td>
            </tr>
            <tr>
                <td class="table_title">Аймақ</td>
                <td><form:select id="select_region" size="35" autofocus="true" path="regionId">
                       <option value="0">Аймақты таңдаңыз</option>
                       <c:forEach var="region" items="${regions}">
                           <option value=${region.id}>${region.regionKzName}</option>
                       </c:forEach>
                    </form:select>
                    <br>
            ...
            <tr>
                ...
                <br>
                <br>
                <input type="button" id="add_user" value="Тіркелу" /></td>
            </tr>
        </table>
        <form:input type="hidden" id="lang" path="lang" value="KZ" />
        </form:form>
