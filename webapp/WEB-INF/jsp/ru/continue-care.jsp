...
<head>
  <meta charset="utf-8">
  <title>Continue-care ru-page</title>
...
<body>
  <section>
     <div class="container">
        ...
        <h2>Отсутствие надежного гемостаза и продолжающееся кровотечение</h2>
        <h3><div id="result_line"></div></h3>
        <h3 >Баллонная тампонада матки</h3>
        <h3 id="second_title" style="text-decoration: underline;">Утеротоническая терапия</h3>
        <div id="second_area" style="display: none">
            <p id="text11"></p>
            <hr>
        </div>
        <h3 id="third_title" style="text-decoration: underline;">Продолжение ИТТ с учетом клинико-лабораторных данных</h3>
        <div id="third_area" style="display: none">
            <p id="text12"></p>
            <h3 id="dbc_page" style="text-decoration: underline;">ДВС синдром</h3>
            <hr>
        </div>
